...
public interface ILeadIngestionService
{
    ...
    ValueTask<PlatformEntities.Lead> UpdateLeadAsync(UpdateLeadCommand command, CancellationToken cancellationToken = default);
}
...
public sealed class UpdateLeadCommand
{
    ...
    public cCoder.ClientRelationshipManagement.Platform.Models.Enums.LeadStatus Status { get; init; }
